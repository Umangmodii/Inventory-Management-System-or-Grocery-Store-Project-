...
height: 2em;
        ...
        <div class="col-xl-8">
            ...
            <div class="card mb-4">
                <div class="p-3 mb-2 bg-primary text-white"> Update Your Address Details</div>
                <div class="card-body">
                </div>
            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-8"><h2> My <b>Address</b></h2></div>
                            <div class="col-sm-4">
                                <button type="button" class="btn btn-info add-new" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus"></i> Add Address</button>
                            </div>
                ...
                <button type="submit" class="btn btn-primary">Add Address</button>
                    ...
                    <table class="table table-striped table-hover table-bordered">
                        ...
                        <tbody>    
                          ...
                          <td>
                                  <a href = {{route('address.delete',['customer_id' => $address->customer_id])}}>  <button class="btn btn-primary">Delete</button> </a>
