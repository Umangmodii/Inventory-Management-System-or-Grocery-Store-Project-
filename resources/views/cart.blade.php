...
$("#back").click(function () {
    ...
    <link href="//maxcdn.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css" rel="stylesheet">
      <table id="cart" class="table table-hover table-condensed">
          ...
          <tr>
            <td data-th="Product">
              <div class="row">
                ...
                <div class="col-sm-10">
                  <h4 class="nomargin">Dark Fantasy</h4>
                  <p>Sunfeast Dark Fantasy Choco Fills Cream</p>
                </div>
              </div>
            </td>
            <td data-th="Price">80</td>
            <td data-th="Quantity">
              <input type="number" class="form-control text-center" value="1">
            </td>
            <td data-th="Subtotal" class="text-center">80</td>
            <td class="actions" data-th="" name="delete">
        ...
        <tfoot>
          <tr class="visible-xs">
            <td class="text-center"><strong>Total 80</strong></td>
          </tr>
          <tr>
            <td><a href="{{url('welcome')}}" class="btn btn-secondary" id="back"><i class="fa fa-angle-left"></i> Continue Shopping</a></td>
            <td colspan="2" class="hidden-xs"></td>
            <td class="hidden-xs text-center"><strong>Total 80</strong></td>
            <td><a href="{{url('checkout_details')}}" class="btn btn-primary" id="next">Checkout <i class="fa fa-angle-right"></i></a></td>
          </tr>
      ...
      <br>
      <div class="d-grid">
      <button type="button" class="btn btn-outline-primary"><i style="font-size:24px" class="fa">&#xf021; <a href="{{url('cart')}}">  Update Cart </a></i></button>
      </div>
    </div>  
